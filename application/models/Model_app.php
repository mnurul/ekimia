...
class Model_app extends CI_Model
{
	...
	function get_comment()
	{
		...
		$this->db->join('testimoni', 'comment.idtesti = testimoni.idtesti', 'left');
		$this->db->join('pelanggan', 'pelanggan.plg_id = comment.plg_id', 'left');
		// $this->db->where('detail_pesanan.plg_id', $plg_id);
		// $this->db->where('detail_pesanan.no_pesanan', $no_pesanan);
		$this->db->order_by('comment.tgl_comment', 'asc');
		$query = $this->db->get();
		return $query;
	}
