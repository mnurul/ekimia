          ...
          <form class="form-horizontal" action="<?= base_url('admin/') . $controller . '/simpan' ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <!-- <div class="form-group">
                ...
                <input type="number" class="form-control" id="" value="" name="harga_digital" placeholder="Masukkan Harga Digital" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Harga Produk Offset (Rp):</label>
                <input type="number" class="form-control" id="" value="" name="harga_offset" placeholder="Masukkan Harga Offset" required>
              </div> -->
              <!-- <div class="form-group">
                <label for="" class="col-sm-4 control-label">Min. Order:</label>
                <input type="number" class="form-control" id="" value="" name="min_order" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Satuan Qty:</label>
                <input type="text" class="form-control" id="" value="" name="satuan_qty" required>
              </div>
              <div class="form-group">
