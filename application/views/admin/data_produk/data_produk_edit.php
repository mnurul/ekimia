        ...
        <div class="card card-outline card-primary">
          ...
          <form class="form-horizontal" action="<?= base_url('admin/') . $controller . '/update/' . $data_edit->produkid ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <!-- <div class="form-group">
                <label for="" class="col-sm-4 control-label">Harga Produk Digital (Rp):</label>
                <input type="number" class="form-control" id="" value="<?= $data_edit->harga_digital ?>" name="harga_digital" placeholder="Masukkan Harga Digital" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Harga Produk Offset (Rp):</label>
                <input type="number" class="form-control" id="" value="<?= $data_edit->harga_offset ?>" name="harga_offset" placeholder="Masukkan Harga Offset" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Min. Order:</label>
                <input type="number" class="form-control" id="" value="<?= $data_edit->min_order ?>" name="min_order" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Satuan Qty:</label>
                <input type="text" class="form-control" id="" value="<?= $data_edit->satuan_qty ?>" name="satuan_qty" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Jenis Bahan:</label>
                <input type="text" class="form-control" id="" value="<?= $data_edit->jenis_bahan ?>" name="jenis_bahan" required>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-4 control-label">Harga Bahan:</label>
                <input type="text" class="form-control" id="" value="<?= $data_edit->harga_bahan ?>" name="satuan_qty" required>
              </div> -->
              <div class="form-group">
