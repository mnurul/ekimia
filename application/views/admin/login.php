...
<head>
  ...
  <title>Admin E-Kimia| Log in</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="<?php echo base_url('assets/backend/') ?>index2.html"><b>E-Commerce E-Kimia </b> Admin Area</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
      <div class="card-body login-card-body">
        ...
        <form action="<?php echo base_url('admin/login/buat_login') ?>" method="post">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-12">
              <button type="submit" class="btn btn-primary btn-block btn-flat" style="background-color:#0278ae !important;">Masuk</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
