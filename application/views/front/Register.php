		...
		<div class="form-popup" style="float: none;">
			...
			<div class="form-popup-content">
				...
				<form id="register-form" method="post" action="<?= base_url('register/create') ?>" enctype="multipart/form-data">
					...
					<button class="button mid secondary" style="background-color:#0278ae !important;">Register <span class="primary">Now!</span></button>
					<a href="<?= base_url('login') ?>"><button type="button" class="button mid primary" style="background-color:#0278ae !important;">Masuk <span class="primary">/ Login!</span></button></a>
				</form>
			</div>
			<!-- /FORM POPUP CONTENT -->
		</div>
