		...
		<div class="form-popup" style="float: none;">
			...
			<div class="form-popup-content">
				...
				<form id="login-form" method="post" action="<?= base_url('login/buat_login') ?>">
					...
					<button class="button mid primary" style="background-color:#0278ae !important;">Masuk <span class="primary">Sekarang!</span></button>
					<a href="<?= base_url('register') ?>"><button type="button" class="button mid secondary" style="background-color:#0278ae !important;">Daftar <span class="primary">/ Register</span></button></a>
				</form>
				<!-- LINE SEPARATOR -->
