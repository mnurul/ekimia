				...
				<div class="information-layout v2">
					...
					<form method="post" action="<?= base_url('keranjang/tambah/') . $produk->produkid ?>" enctype="multipart/form-data">
						<div class="form-row information-layout-item">
							...
							<input value="1" type="number" name="qty" id="qty" required>
							<input type="hidden" id="harga" value="<?= $produk->produk_harga ?>">
						</div>
						<div class="form-row information-layout-item">
							<div class="form-group col-md-6">
								<p class="text-header">Berat : </p>
								<input min="0" type="number" name="weight" id="weight" value="<?= $produk->produk_berat ?>" required readonly>
							</div>
							<div class="form-group col-md-6">
								<p class="text-header">satuan : </p>
								<input type="text" name="weight" id="weight" value="<?= $produk->satuan_qty ?>" required readonly>
							</div>
						</div>
