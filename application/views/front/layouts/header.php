			...
			<div class="user-board">
				<?php if ($this->session->userdata('login_pelanggan') == 'login') : ?>
					...
					<div class="user-quickview">
						...
						<!-- DROPDOWN -->
						<ul class="dropdown small hover-effect closed" style="margin-top: -40px !important;">
				...
				<?php if ($this->session->userdata('login_pelanggan') != 'login') : ?>
					...
					<div class="account-actions">
						<a href="<?= base_url('login') ?>" class="button primary" style="background: #DC014D;">Masuk / Login</a>
						<a href="<?= base_url('register') ?>" class="button secondary" style="background: #DC014D;">Daftar / Register</a>
					</div>
					<!-- /ACCOUNT ACTIONS -->
				<?php endif ?>
