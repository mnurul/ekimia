...
<style>
	.banner-wrap {
		background: linear-gradient(0deg, rgb(0 0 0 / 57%), rgb(0 0 0 / 63%)), url("<?php echo base_url('assets/') ?>images/banner-1.png") no-repeat center;
...
<div class="banner-wrap">
	<section class="banner">
		...
		<h1>E-Commerce <span>E-Kimia </span></h1>
		<!-- <p>Cv. Mitra kreasi</p> -->
