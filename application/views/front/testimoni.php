				...
				<div class="comment-list">
					...
					?>
						...
						<div class="comment-wrap">
							...
							?>
								<?php if ($comment->idtesti == $testi->idtesti) : ?>
									<div class="comment-wrap">
										<!-- USER AVATAR -->
										<a href="user-profile.html">
											<figure class="user-avatar medium">
												<img src="<?= base_url('assets/img/pelanggan/' . $comment->plg_foto) ?>" alt="">
											</figure>
										</a>
										<!-- /USER AVATAR -->
										<div class="comment">
											<p class="text-header"><?= $comment->plg_nama ?></p>
											<p class="timestamp"><?= $comment->tgl_post ?></p>
							...
							<?php endforeach ?>
							<!-- /Comment -->
							<form class="comment-reply-form" method="post" action="<?= base_url('Testimoni/comment') ?>">
								<input type="text" class="form-control" name="idtesti" value="<?= $testi->idtesti ?>" hidden>
								<textarea name="isi_testi" placeholder="Comment testi here..."></textarea>
								<button class="button primary">Comment Testimoni</button>
							</form>
						</div>
						<!-- /COMMENT -->
